...
namespace HygieiaApp.DataAccess.Migrations
{
    ...
    [Migration("20230702102405_Updates")]
            ...
            modelBuilder.Entity("HygieiaApp.Models.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3bb7950b-54c9-4915-837c-7f2461ebfd27"),
                            Name = 2
                        },
                        new
                        {
                            Id = new Guid("c01e7ba8-1650-4be6-8ca6-312bbd4fc472"),
                            Name = 1
                        },
                        new
                        {
                            Id = new Guid("b2a4408c-0e12-44c2-bc8c-d98084fc7f0b"),
                            Name = 0
                        });
                });
