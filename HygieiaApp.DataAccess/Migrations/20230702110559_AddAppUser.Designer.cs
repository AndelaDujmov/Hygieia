...
namespace HygieiaApp.DataAccess.Migrations
{
    ...
    [Migration("20230702110559_AddAppUser")]
            ...
            modelBuilder.Entity("HygieiaApp.Models.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0acb36e-bf3d-4a30-913d-4cb7c0eb0a8d"),
                            Name = 2
                        },
                        new
                        {
                            Id = new Guid("0fbe4c7b-0586-4f4b-a12a-8ea056c2244d"),
                            Name = 1
                        },
                        new
                        {
                            Id = new Guid("cf857f61-3d12-4414-9863-1d3e924320f3"),
                            Name = 0
                        });
                });
