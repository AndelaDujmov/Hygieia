...
namespace HygieiaApp.DataAccess.Migrations
{
    ...
    [Migration("20230506184539_DataEntry")]
            ...
            modelBuilder.Entity("HygieiaApp.Models.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8db39293-64ef-4e77-948b-26a897e131bf"),
                            Name = 2
                        },
                        new
                        {
                            Id = new Guid("255ccbb2-2c45-4913-abe8-3312d5efc2c3"),
                            Name = 1
                        },
                        new
                        {
                            Id = new Guid("b924535a-89c5-4477-8458-cf367db47224"),
                            Name = 0
                        });
                });
