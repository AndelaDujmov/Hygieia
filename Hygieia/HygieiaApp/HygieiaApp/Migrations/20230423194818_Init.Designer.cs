...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HygieiaApp.Models.Immunization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HygieiaApp.Models.MedicalCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.MedicalConditionMedicated", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.MedicalConditionMedication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.Medication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.PatientDoctor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.PatientMedicalCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.Scheduler", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.TestResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HygieiaApp.Models.Immunization", b =>
                {
                    b.HasOne("HygieiaApp.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HygieiaApp.Models.MedicalCondition", b =>
                {
                    b.HasOne("HygieiaApp.Models.PatientMedicalCondition", null)
            ...
            modelBuilder.Entity("HygieiaApp.Models.MedicalConditionMedicated", b =>
                {
                    b.HasOne("HygieiaApp.Models.MedicalConditionMedication", "MedicalConditionMedication")
                        .WithMany()
                        .HasForeignKey("MedicalConditionMedicationId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HygieiaApp.Models.PatientMedicalCondition", "MedicalConditionPatient")
                        .WithMany()
            ...
            modelBuilder.Entity("HygieiaApp.Models.MedicalConditionMedication", b =>
                {
                    b.HasOne("HygieiaApp.Models.MedicalCondition", "MedicalCondition")
                        .WithMany()
                        .HasForeignKey("MedicalConditionId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HygieiaApp.Models.Medication", "Medication")
                        .WithMany()
            ...
            modelBuilder.Entity("HygieiaApp.Models.PatientDoctor", b =>
                {
                    b.HasOne("HygieiaApp.Models.User", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HygieiaApp.Models.User", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("HygieiaApp.Models.User", b =>
                {
                    b.HasOne("HygieiaApp.Models.Role", "Role")
                        .WithMany()
