...
namespace HygieiaApp.DataAccess.Migrations
{
    ...
    [Migration("20230629175616_AddIdentityTables")]
            ...
            modelBuilder.Entity("HygieiaApp.Models.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("80de1075-53ef-49c9-bfec-2943aa9036fe"),
                            Name = 2
                        },
                        new
                        {
                            Id = new Guid("ac2b73ea-510d-4b78-a5f9-6832bc341546"),
                            Name = 1
                        },
                        new
                        {
                            Id = new Guid("e24420b9-a575-49db-bc32-bf29ac6f9c90"),
                            Name = 0
                        });
                });
